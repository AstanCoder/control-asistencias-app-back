...
const create_professor_1 = __importDefault(require("./controller/create_professor"));
...
authRouter
    ...
    .post("/create-professor", verifyToken_1.verifyToken, create_professor_1.default);
